...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=leogsouza.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x61, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xb1, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x6c, 0x65, 0x6f, 0x67, 0x73, 0x6f,
	0x75, 0x7a, 0x61, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x0a, 0x08, 0x54, 0x45, 0x52, 0x41, 0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x45, 0x0a, 0x1e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: leogsouza.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: leogsouza.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: leogsouza.pcbook.Memory.unit:type_name -> leogsouza.pcbook.Memory.Unit
